...
```javascript
import { caxpy, ccopy, cscal, csscal, cswap, dasum, daxpy, dcopy, ddot, dnrm2, dscal, dswap, gasum, gaxpy, gcopy, gdot, gnrm2, gscal, gswap, sasum, saxpy, scopy, sdot, snrm2, sscal, sswap, zaxpy, zcopy, zdscal, zscal, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@esm/index.mjs';
```
