...
```javascript
import { caxpy, ccopy, cscal, csscal, cswap, dasum, daxpy, dcopy, ddot, dscal, dswap, gasum, gaxpy, gcopy, gdot, gscal, gswap, sasum, saxpy, scopy, sdot, sscal, sswap, zaxpy, zcopy, zscal, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@esm/index.mjs';
```
