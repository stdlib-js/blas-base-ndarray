...
```javascript
import { caxpy, ccopy, cswap, dasum, daxpy, dcopy, ddot, dscal, dswap, gasum, gaxpy, gcopy, gdot, gswap, sasum, saxpy, scopy, sdot, sscal, sswap, zaxpy, zcopy, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@esm/index.mjs';
```
