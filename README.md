...
```javascript
import { caxpy, dasum, daxpy, dcopy, ddot, gasum, gaxpy, gcopy, gdot, sasum, saxpy, scopy, sdot, zaxpy } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@deno/mod.js';
```
