...
```javascript
import { caxpy, ccopy, cgemv, cscal, csscal, cswap, dasum, daxpy, dcopy, ddot, dgemv, dger, dnrm2, dscal, dsdot, dspr, dswap, dsyr2, dzasum, dznrm2, gasum, gaxpy, gcopy, gdot, ggemm, ggemv, gger, gnrm2, gscal, gswap, gsyr, idamax, igamax, isamax, sasum, saxpy, scasum, scnrm2, scopy, sdot, sdsdot, sgemv, sger, snrm2, sscal, sspr, sswap, zaxpy, zcopy, zdscal, zscal, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@esm/index.mjs';
```
