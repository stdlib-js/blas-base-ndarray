...
```javascript
import { caxpy, ccopy, dasum, daxpy, dcopy, ddot, dswap, gasum, gaxpy, gcopy, gdot, sasum, saxpy, scopy, sdot, sswap, zaxpy, zcopy } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@deno/mod.js';
```
