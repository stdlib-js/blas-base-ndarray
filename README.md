...
```javascript
import { caxpy, ccopy, cgemv, cscal, csscal, cswap, dasum, daxpy, dcopy, ddot, dger, dnrm2, dscal, dsdot, dswap, dzasum, dznrm2, gasum, gaxpy, gcopy, gdot, ggemv, gnrm2, gscal, gswap, idamax, igamax, isamax, sasum, saxpy, scasum, scnrm2, scopy, sdot, sdsdot, snrm2, sscal, sswap, zaxpy, zcopy, zdscal, zscal, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@esm/index.mjs';
```
