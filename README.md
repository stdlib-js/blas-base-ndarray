...
```javascript
import { caxpy, ccopy, cscal, csscal, cswap, dasum, daxpy, dcopy, ddot, dnrm2, dscal, dsdot, dswap, dznrm2, gasum, gaxpy, gcopy, gdot, gnrm2, gscal, gswap, sasum, saxpy, scasum, scnrm2, scopy, sdot, sdsdot, snrm2, sscal, sswap, zaxpy, zcopy, zdscal, zscal, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray@deno/mod.js';
```
